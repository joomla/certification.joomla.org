...
<script type="text/javascript">
    ...
    Joomla.submitbutton = function (task) {
        if (task == 'certified_user.cancel') {
            Joomla.submitform(task, document.getElementById('certified_user-form'));
        } else {

            if (task != 'certified_user.cancel' && document.formvalidator.isValid(document.id('certified_user-form'))) {
...
<form
        ...
        method="post" enctype="multipart/form-data" name="adminForm" id="certified_user-form"
    ...
    <div class="row-fluid">
        <div class="span10 form-horizontal">
            <fieldset class="adminform">
				...
				<?php echo $this->form->renderField('certifications'); ?>
