...
/**
 * Jcpqm component helper.
 */
abstract class JcpqmHelper
{

/* BEGIN BEGIN BEGIN BEGIN BEGIN BEGIN BEGIN BEGIN BEGIN BEGIN BEGIN BEGIN BEGIN BEGIN BEGIN BEGIN
*
*  TODO MDI admin helper conmponent :: BEGIN
*
*/
/* 
*  TODO MDI admin helper conmponent :: END
*   
END END END END END END END END END END END END END END END END END END END END END END END END */
	...
	**/
	...
	{
		$manifestUrl = JPATH_ADMINISTRATOR."/components/com_jcpqm/jcpqm.xml";
	...
	**/
	...
	{
		// get params
		$params	= JComponentHelper::getParams('com_jcpqm');
	...
	**/
	public static function addSubmenu($submenu)
	{
		...
		JHtmlSidebar::addEntry(JText::_('COM_JCPQM_SUBMENU_DASHBOARD'), 'index.php?option=com_jcpqm&view=jcpqm', $submenu === 'jcpqm');
		if ($user->authorise('question.access', 'com_jcpqm') && $user->authorise('question.submenu', 'com_jcpqm'))
		{
			JHtmlSidebar::addEntry(JText::_('COM_JCPQM_SUBMENU_QUESTIONS'), 'index.php?option=com_jcpqm&view=questions', $submenu === 'questions');
			JHtmlSidebar::addEntry(JText::_('COM_JCPQM_QUESTION_QUESTION_CATEGORY'), 'index.php?option=com_categories&view=categories&extension=com_jcpqm.question', $submenu === 'categories.question');
		}
		if ($user->authorise('exam.access', 'com_jcpqm') && $user->authorise('exam.submenu', 'com_jcpqm'))
		{
			JHtmlSidebar::addEntry(JText::_('COM_JCPQM_SUBMENU_EXAMS'), 'index.php?option=com_jcpqm&view=exams', $submenu === 'exams');
		}
	}
	 ...
	 */
	public static function xls($rows,$fileName = null,$title = null,$subjectTab = null,$creator = 'Joomla!',$description = null,$category = null,$keywords = null,$modified = null)
	{
		// set the user
		$user = JFactory::getUser();
	 ...
	 *
	 */
	public static function getVar($table, $where = null, $whereString = 'user', $what = 'id', $operator = '=', $main = 'jcpqm')
	{
		if(!$where)
		{
	 ...
	 *
	 */
	public static function getVars($table, $where = null, $whereString = 'user', $what = 'id', $operator = 'IN', $main = 'jcpqm', $unique = true)
	{
		if(!$where)
		{
			$where = JFactory::getUser()->id;
	...
	* 
	**/
	public static function getActions($view, &$record = null, $views = null, $target = null, $component = 'jcpqm')
	{
		// get the user object
		$user = JFactory::getUser();
		// load the JObject
	...
	**/
	public static function getModel($name, $path = JPATH_COMPONENT_ADMINISTRATOR, $Component = 'Jcpqm', $config = array())
	{
		// fix the name
	...
	*/
	public static function setAsset($id, $table, $inherit = true)
	{
		...
		$parent->loadByName('com_jcpqm');
		
		$parentId = $parent->id;
		$name     = 'com_jcpqm.'.$table.'.'.$id;
		$title    = '';
		...
		else
		{
			...
			$rules = self::getDefaultAssetRules('com_jcpqm', $table, $inherit);
			...
			else
			{
				...
				return JFactory::getDbo()->updateObject('#__jcpqm_'.$table, $object, 'id');
			}
		}
		return false;
	}
