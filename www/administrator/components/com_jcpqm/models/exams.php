 ...
 * Exams Model
 */
class JcpqmModelExams extends JModelList
{
...
*
*  TODO MDI model(list view) EXAM :: BEGIN
*
*/
/* MDI Button model list view EXAM :: END 
   END END END END END END END END END END END END END END END END END END END END END END END END */
	...
	public function getItems()
	{
		...
		if (JcpqmHelper::checkArray($items))
		{
			...
			{
				$access = (JFactory::getUser()->authorise('exam.access', 'com_jcpqm.exam.' . (int) $item->id) && JFactory::getUser()->authorise('exam.access', 'com_jcpqm'));
				if (!$access)
				{
					unset($items[$nr]);
					continue;
	...
	protected function checkInNow()
	{
		...
		if ($time)
		{
			...
			if ($db->getNumRows())
			{
				...
				// Check table
				$query->update($db->quoteName('#__jcpqm_exam'))->set($fields)->where($conditions); 
