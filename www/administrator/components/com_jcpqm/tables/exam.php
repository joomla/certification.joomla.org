 ...
 * Exams Table class
 */
class JcpqmTableExam extends JTable
{
	/**
	...
	{
		parent::__construct('#__jcpqm_exam', 'id', $db);

		// Adding History Options
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jcpqm.exam'));
	}	
	...
	/**
	 * Overload the store method for the Exam table.
	 *
	...
	public function store($updateNulls = false)
	{
		...
		{
			// New exam. A exam created and created_by field can be set by the user,
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_JCPQM_EXAM_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_jcpqm.exam.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_jcpqm.exam.'.(int) $this->$k;
	}
