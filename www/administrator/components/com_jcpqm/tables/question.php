 ...
 */
class JcpqmTableQuestion extends JTable
{
	/**
	...
	{
		parent::__construct('#__jcpqm_question', 'id', $db);

		// Adding History Options
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jcpqm.question'));
	}	
	...
	/**
	 * Overload the store method for the Question table.
	 *
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_JCPQM_QUESTION_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_jcpqm.question.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_jcpqm.question.'.(int) $this->$k;
	}
	...
	public function generateAlias()
	{
		if (empty($this->alias))
		{
			$this->alias = $this->question_title;
		}
